...
smart wallets** on **EVM**. There is no seed phrase and no browser extension. Every wallet is a
smart EOA through [EIP-7702](https://eips.ethereum.org/EIPS/eip-7702).
...
Avok ships **no default** RPC, bundler, or paymaster. Each one is a trust boundary you
choose. Sending and signing go through the announced EIP-1193 provider, driven by stock wagmi, viem,
ethers, and RainbowKit. There is no `useSend` hook.
