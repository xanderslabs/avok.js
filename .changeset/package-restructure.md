...
Package restructure — **BREAKING**: 11 packages → 3 published. The SDK is now one framework-agnostic
...
**New public package — `@avokjs/core`.** It *is* the plain-JS/browser SDK (the old `@avokjs/vanilla`,
