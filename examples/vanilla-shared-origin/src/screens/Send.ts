...
import { formatAmount, txReduce, type TxState } from "@avokjs/helpers";
...
export function Send(ctx: Ctx): HTMLElement {
  ...
  function switchRail(next: Rail): void {
    set({ rail: next, step: "form", tokenIdx: 0, feeTokenIdx: 0, evmSendCalls: null, solSim: null, formError: null, err: null, resolvedTo: null, resolvedFrom: null, explorerUrl: undefined, txState: txReduce(s.txState, "reset") });
  }
