...
export function mountApp(root: HTMLElement, ctx: Ctx, screens: Record<Nav | "onboard", ScreenFn>): void {
  ...
  function render(): void {
    ...
    if (nav === "account") {
      parts.push(
        el("div", { class: "shell-logout" }, el("button", { class: "btn btn-ghost", onclick: logout }, "Log out")),
      );
    }
