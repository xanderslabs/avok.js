...
provider** over [EIP-6963](https://eips.ethereum.org/EIPS/eip-6963). You send and sign with the
standard ecosystem tools (wagmi, viem, ethers, or RainbowKit), which discover Avok like any other
wallet.
