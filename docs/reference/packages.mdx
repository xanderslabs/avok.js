...
| Package | Purpose |
| --- | --- |
| `@avokjs/core` | The framework-agnostic SDK and the plain-JS/browser SDK. Engine, client, provider, shared-origin channel, name resolution, and the auth-popup mountable. Exposed through subpath exports. |
