...
description: "Sending and signing go through the announced EIP-1193 provider, driven by stock tools."
---
...
An EIP-1193 provider, announced over [EIP-6963](https://eips.ethereum.org/EIPS/eip-6963). wagmi,
viem, ethers, and RainbowKit discover it like any other injected wallet.
