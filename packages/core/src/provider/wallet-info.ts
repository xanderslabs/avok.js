 ...
 * Avok one — Avok is a white-label SDK (VISION §1), so the wallet a dapp discovers via EIP-6963 is named
 * and iconed by whoever ships the wallet, never hardcoded.
 *
...
export interface WalletInfo {
  /** Display name in the wallet picker (EIP-6963). Defaults to the origin's hostname. */
  name?: string;
