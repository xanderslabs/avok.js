 ...
 *
 * This is not a server config: there is no issuer, no signing key, no client registration, and no
 * store. It is the handful of values the operator bakes into their own clone-and-own build of the
 * popup (VISION §7).
 *
