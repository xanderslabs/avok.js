 ...
 *
 * A general primitive, not specific to any one actor: both the wallet OWNER managing their guardian
 * set (`guardian-calls.ts`) and the vault's own recovery page (`vault/recover/`, which re-exports
 * this) read the same state for different reasons.
 */
