...
/** native-gas: the wallet EOA's own type-4 tx calls execute(MODE_BATCH, executionData). Fee calls first. */
export function buildNativeGasCalldata(batch: ResolvedBatch): Hex {
