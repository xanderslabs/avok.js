...
/**
 * The blob version this implementation WRITES. Every new access slot is written under it.
 *
 ...
 *  measurably cheaper to store — 249,806 gas versus 316,465 for a 156-byte JSON envelope, a saving
 *  of 66,659 gas on every access-slot write. Both sides are measured cold with non-zero ciphertext
 *  by contracts/test/GasMeasure.t.sol, which pins the saving. */
