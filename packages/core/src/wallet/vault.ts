 ...
 * passkey whose slot write never landed — indistinguishable from an RPC blip, which leaves orphans
 * invisible rather than merely unrepaired.
 */
 ...
 *  K-derived key by the wallet module). It is public on chain, so it is safe to hand around here; pass an
