 ...
 * EIP-1193 provider over the config and announces it via EIP-6963 — in-page, once, and only in a browser
 * (SSR / non-DOM hosts no-op). Returns the client with a `getEip1193Provider()` handle for direct
 * (non-wagmi) use.
 *
