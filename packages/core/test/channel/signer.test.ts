...
import type { SigningChannel } from "../../src/channel/channels/port.js";
import type { SignedAuthorizationLike } from "../../src/channel/types.js";
...
describe("composite ops — one round-trip, one popup", () => {
  ...
  // carries the (unsigned) v0.9 UserOperation + chainId, so the ORIGIN recomputes the userOpHash from
