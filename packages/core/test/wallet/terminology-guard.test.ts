...
// Repo root = four levels up from this test file (packages/core/test/wallet).
const ROOT = join(import.meta.dirname, "../../../..");

function sources(): string[] {
  // Scan shipped source only — never dist/node_modules (tests live under test/, so the src/** glob
  // never picks them up).
