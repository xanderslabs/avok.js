...
import type { DiscoveredPasskey, PasskeyAdapter, PasskeyRegistration } from "../../src/wallet/index.js";
import { bytesToBase64Url } from "../../src/wallet/index.js";
import type { RpcClient, SimulateArgs, SimCallResult, ReadArgs } from "../../src/evm/index.js";
 ...
 *  handle, `discover()` surfaces `{ credentialId, prfOutput, userHandle }`. Models the wallet module's
 ...
 *
 * A NATIVE-GAS access-slot write is ONE passkey gesture — resolve with no key (prepare), seal AND sign
