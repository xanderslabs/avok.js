...
import {
  ...
  SLOT_INFO_PREFIX,
  SLOT_META_INFO,
} from "../src/crypto/derive-wallet.js";
import { PAIRING_INFO_PREFIX } from "../src/pairing.js";
import { getPrfSalt } from "../src/passkey/web.js";
import { encryptKeyBlob } from "../src/crypto/blob.js";
import { deriveSlotId } from "../src/passkey/label.js";
import { bytesToArrayBuffer } from "../src/encoding.js";
import { deserializeContainer, type SecretContainer } from "../src/crypto/container.js";
...
describe("domain strings are vendor-neutral", () => {
  ...
  it("no derivation module contains a vendor-named string literal at all", () => {
    const modules = [
      "../src/crypto/derive-wallet.ts",
      "../src/crypto/blob.ts",
      "../src/crypto/slot-meta.ts",
      "../src/pairing.ts",
      "../src/enrolment.ts",
      "../src/passkey/web.ts",
    ];
