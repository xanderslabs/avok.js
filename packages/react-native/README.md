...
This rail depends on the PRF extension evaluating inside an in-app browser tab, which is measured on
real hardware rather than assumed. See `VERIFICATION.md` §3b for the result, its date, the minimum
OS versions, and how to re-run the check.
