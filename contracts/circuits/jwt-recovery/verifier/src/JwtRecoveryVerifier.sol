...
//
// GENERATED FILE -- do not hand-edit. Produced by `bb write_solidity_verifier` (barretenberg
// v0.87.0) from the verification key of circuits/jwt-recovery (Noir 1.0.0-beta.11), which wraps
// zkemail/noir-jwt v0.5.1 (RS256/2048 JWT verification) with pubkeyHash/identity/nonceBinding
// public outputs matching IUltraHonkVerifier and OidcRecoveryGuardian's PUBLIC_INPUTS_LENGTH=3.
// Regenerate via: cd circuits/jwt-recovery && nargo compile &&
//   bb write_vk --scheme ultra_honk --oracle_hash keccak -b target/jwt_recovery.json -o target &&
//   bb write_solidity_verifier --scheme ultra_honk -k target/vk -o target/Verifier.sol
// `HonkVerifier`'s ABI (verify(bytes,bytes32[])->bool) matches IUltraHonkVerifier exactly; it is
// wired in as that interface at deploy time rather than declared to implement it here, to keep
// this file an unmodified copy of bb's output.
...
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({ 
               x: uint256(0x16ef2dea54ace630dced9d7db0604db2dd432f8329138a288bd401077de0c4e6),
               y: uint256(0x2f7dfee914bbdfa40276563c14fdc22d2cd351e5e232cd52be04e0faa58711a9)
            }),
            qr: Honk.G1Point({ 
               x: uint256(0x02ea0bc7c650992bdc4782eda1d0404ec7e3d6b0efe05f52e7d3fc916fa28a5d),
               y: uint256(0x2bcf271da5106d603f77fef6c790003d5a212a3f8b8d28382bff3fb4657e282d)
            }),
            qo: Honk.G1Point({ 
               x: uint256(0x10386a3eec77298887ddabe7e1eb870b069ebc645a1241148944777e540fe245),
               y: uint256(0x0703a669ab2ee4521fcb66052e39b08a49cbc45cca5030bba1fb9bd987b592c4)
            }),
            q4: Honk.G1Point({ 
               x: uint256(0x0b29e7e1b38942ecc327ca917257aaff1f611dd795a8262ccd3c08e7aced1ce8),
               y: uint256(0x0c9bbd084a86f3d9a59dd81aeb8f7f0f06839a8bc6cf04a493b50f0e157673db)
            }),
            qm: Honk.G1Point({ 
               x: uint256(0x25a2030a76d31042bf033c33ff9eaab6c7ba5ecd21988be8d63d6d87eaae89a7),
               y: uint256(0x0b5f8752e54a8d96634aa7ba23bab1d18265efd093efacda6ce5e4de28823f10)
            }),
            qc: Honk.G1Point({ 
               x: uint256(0x2a6e35b4456a4703e573722af24a2cf155d94686e03a3a1f11d967b40cb98ea0),
               y: uint256(0x001a5b23962395fff2a6a4c1d6ff8ca4b7c26a967d9f2c02ef4c6599b36a0833)
            }),
            qArith: Honk.G1Point({ 
               x: uint256(0x04246daa7daa6999babe9618ecde12359985ae4bdc472c085b5334feaf775bf9),
               y: uint256(0x1e43f06d3aaedcf60447690a43562c46db7e54b95f80f7967c4c830f3130b994)
            }),
            qDeltaRange: Honk.G1Point({ 
               x: uint256(0x104be061f2ba307dea6d705e4cb670b8b04d44795a47eeab3d3d5777bddf0955),
               y: uint256(0x281738123f56a45df8ad8fc0373b666c74614d9b948d1bde6d14ff39b67f914a)
            }),
            qElliptic: Honk.G1Point({ 
               x: uint256(0x245682fa22c9cea178fe31a1261d0c7b8583069b1a668e581248e669d9703fbd),
               y: uint256(0x24451d8c20326f6fc1e62a4830388badd9507ca3f6c9cac93f71023af1e04aec)
            }),
            qAux: Honk.G1Point({ 
               x: uint256(0x2ee918755339aa46521f8f184589a36ca1ed391c4b67697cea941f0972ab554e),
               y: uint256(0x15ff9de04753fc4cd41c4babfa2b598f73de8bafb651f4d75ef901716c141a31)
            }),
            qLookup: Honk.G1Point({ 
               x: uint256(0x18ece64417a18e67045fb7cd50f66a9d5af9e279357bf7f2640e148e485d3630),
               y: uint256(0x291813ac7d6b27457369c81e6e6744a013cf5d786a0e8a8b3887e55ef577d4ea)
            }),
            qPoseidon2External: Honk.G1Point({ 
               x: uint256(0x