...
export const AvokWalletImplementationABI = [
  ...
  {
    type: "function",
    name: "hashExecuteBatch",
    inputs: [CALL_TUPLE, { name: "nonce", type: "uint256" }, { name: "deadline", type: "uint256" }],
    outputs: [{ name: "", type: "bytes32" }],
    stateMutability: "view",
  },
  {
  ...
  {
    type: "event",
    name: "AccessSlotAdded",
    inputs: [
      { name: "wallet", type: "address", indexed: true },
      { name: "slotId", type: "bytes32", indexed: false },
      { name: "blobHash", type: "bytes32", indexed: false },
